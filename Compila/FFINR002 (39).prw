...
//		       	@nLin,000 PSAY PADR(a_Titulos[i][1], 20) 
                ...
                // BUSCA NAT FINANCEIRA ////////////////////////////////////////////////////wellington
                   ...
                   m_valor = Transform(a_Titulos[i][7],"@E 999,999,999.99")
                   ...
                   M_USUARIO = PADR(a_Titulos[i][1], 6)
             ...
             //    ENDIF                                                       
               ...
               If AllTrim(c_Tipo) == 'Receber' .AND. M_NAT = " "
                  M_NAT = "10101" 
                  M_DESC_NAT = "VENDAS"
               ENDIF   
...
//		   		@nLin,024 PSAY PADR(MemoLine(AllTrim(a_Titulos[i][2]),55,1), 45)
		    	...
		    	//	@nLin,112 PSAY Transform(a_Titulos[i][7],"@E 999,999,999.99")
      		  		@nLin,112 PSAY Transform(apagar,"@E 999,999,999.99")
		  		Else
		    		@nLin,097 PSAY Transform(a_Titulos[i][7],"@E 999,999,999.99")
		  		Endif
	    		...
	    		@nLin,127 PSAY Transform(n_Saldo,"@E 999,999,999.99")	   
	    		
	      //		@nLin,140 PSAY  PADR(a_Titulos[i][10], 6) 
...
//	  	@nLin,117 PSAY Transform(n_TotDia,"@E 999,999,999.99")
	  	@nLin,097 PSAY Transform(n_TotDia,"@E 999,999,999.99")
	  	nLin := nLin + 1 // Avanca a linha de impressao
	  	@nLin,000 PSAY "Total a Receber no dia " + Dtoc(d_Dia) + " - "
//	  	@nLin,117 PSAY Transform(n_TotDiaRc,"@E 999,999,999.99")
	  	@nLin,097 PSAY Transform(n_TotDiaRc,"@E 999,999,999.99")
	  	nLin := nLin + 1 // Avanca a linha de impressao
...
//  	@nLin,117 PSAY Transform(n_Total,"@E 999,999,999.99")
  	@nLin,097 PSAY Transform(n_Total,"@E 999,999,999.99")
  	nLin := nLin + 1 // Avanca a linha de impressao
  	@nLin,000 PSAY "Total a Receber no Período - "
//  	@nLin,117 PSAY Transform(n_TotalRec,"@E 999,999,999.99")
  	@nLin,097 PSAY Transform(n_TotalRec,"@E 999,999,999.99")
  	nLin := nLin + 1 // Avanca a linha de impressao
...
//  	c_Qry += " (SELECT A2_NOME FORNECE, C7_OBS OBS, '' NOTA, C7_NUM PEDIDO, C7_EMISSAO EMISSAO, '' VENC, SUM(C7_TOTAL)+SUM(C7_VALIPI) AS VALOR, C7_COND CONDICAO, 'Previstos' TIPO" + chr(13)
 ...
 //  	c_Qry += " GROUP BY C7_NUM, A2_NOME, C7_OBS, C7_EMISSAO, C7_COND " + chr(13)
