...
ฑฑบPrograma  ณPCOMA031      บAutor  ณDIEGO ARGOLO     บ Data ณ  29/07/13  บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function PCOMA031(c_Pedido)
...
c_Msg += '    		<p>O PC '+c_Pedido+' estแ aguardando a sua Aprova็ใo/Rejei็ใo.</p>'
c_Msg += '		</font>'
c_Msg += ' 	</td>'
c_Msg += '  </tr>'
c_Msg += '</table>'
...
DBSELECTAREA("SCR")
DBSETORDER(1)
MsSeek(xFilial('SCR')+"PC"+c_Pedido,.T.)  		
While SCR->(!Eof()).and. Alltrim(CR_NUM)==Alltrim(c_Pedido)
