...
Local a_Area		:= GetArea() //Diligenciamento   
Local l_Ret 		:= Findfunction("U_PCOMA012") //Diligenciamento

//Diligenciamento - inicio
If l_Ret 
	U_PCOMA012(SF1->F1_DOC,SF1->F1_SERIE,SF1->F1_FORNECE,SF1->F1_LOJA) //CHAMA A FUNCAO QUE ENVIAR UM EMAIL PARA O SOLICITANTE 
Endif           

RestArea(a_Area)
//Diligenciamento - fim

//Código pré-existente na bomix
