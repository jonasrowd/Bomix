...
ฑฑบPrograma  ณFESTR004  บAutor  ณ                    บ Data ณFEVEREIRO/11 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณRelatorio de Apontado x Transferido					      บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
Static Function CriaPerg(c_Perg)
	//PutSx1(cGrupo,cOrdem,cPergunt,cPerSpa,cPerEng,cVar,cTipo ,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3, cGrpSxg,cPyme,cVar01,cDef01,cDefSpa1,cDefEng1,cCnt01, cDef02,cDefSpa2,cDefEng2,cDef03,cDefSpa3,cDefEng3, cDef04,cDefSpa4,cDefEng4, cDef05,cDefSpa5,cDefEng5, aHelpPor,aHelpEng,aHelpSpa,cHelp)
 	...
 	fPutSx1(c_Perg,"02","OP at้?" 		,"","","mv_ch2","C",TamSX3("D3_OP")[1],0,0,"G","","SC2","","","mv_par02","","","","","","","","","","","","","","","","")
 	fPutSx1(c_Perg,"03","Produto de?"    ,"","","mv_ch3","C",TamSX3("B1_COD")[1],0,0,"G","","SB1"   ,"","","mv_par03","","","","","","","","","","","","","","","","")
 	fPutSx1(c_Perg,"04","Produto at้?"   ,"","","mv_ch4","C",TamSX3("B1_COD")[1],0,0,"G","","SB1"   ,"","","mv_par04","","","","","","","","","","","","","","","","")
 	fPutSx1(c_Perg,"05","Lote de?"    	,"","","mv_ch5","C",TamSX3("D3_LOTECTL")[1],0,0,"G","",""  ,"","","mv_par05","","","","","","","","","","","","","","","","")
 	fPutSx1(c_Perg,"06","Lote at้?"   	,"","","mv_ch6","C",TamSX3("D3_LOTECTL")[1],0,0,"G","",""  ,"","","mv_par06","","","","","","","","","","","","","","","","")
 	fPutSx1(c_Perg,"07","Emissใo de?"    ,"","","mv_ch7","D",8,0,0,"G","",""   	  ,"","","mv_par07","","","","","","","","","","","","","","","","")
 	fPutSx1(c_Perg,"08","Emissใo at้?"   ,"","","mv_ch8","D",8,0,0,"G","",""   	  ,"","","mv_par08","","","","","","","","","","","","","","","","")
 	fPutSx1(c_Perg,"09","Local de?"    	,"","","mv_ch9","C",TamSX3("D3_LOCAL")[1],0,0,"G","","NNR"   	  ,"","","mv_par09","","","","","","","","","","","","","","","","")
 	fPutSx1(c_Perg,"10","Local at้?"   	,"","","mv_cha","C",TamSX3("D3_LOCAL")[1],0,0,"G","","NNR"   	  ,"","","mv_par10","","","","","","","","","","","","","","","","")
// 	PutSx1(c_Perg,"11","Documento de?" 	,"","","mv_chb","C",TamSX3("D3_DOC")[1],0,0,"G","",""   	  ,"","","mv_par11","","","","","","","","","","","","","","","","")
// 	PutSx1(c_Perg,"12","Documento at้?"	,"","","mv_chc","C",TamSX3("D3_DOC")[1],0,0,"G","",""   	  ,"","","mv_par12","","","","","","","","","","","","","","","","")
Return Nil
...
Static Function fPutSX1(cGrupo,cOrdem,cPergunt,cPerSpa,cPerEng,cVar,cTipo ,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3, cGrpSxg,cPyme,cVar01,cDef01,cDefSpa1,cDefEng1,cCnt01, cDef02,cDefSpa2,cDefEng2,cDef03,cDefSpa3,cDefEng3, cDef04,cDefSpa4,cDefEng4, cDef05,cDefSpa5,cDefEng5, aHelpPor,aHelpEng,aHelpSpa,cHelp)
	...
	If !Empty(cGrupo) .And. !Empty(cOrdem) .And. !Empty(cPergunt) .And. !Empty(cVar01) .And. !Empty(cVar) .And. !Empty(cTipo) .And. nTamanho != 0
		...
		nPreSel    := Iif(cGSC == "C", 1, 0)                      	  //Se for Combo, o pr้-selecionado serแ o Primeiro
		cDef01     := Iif(cGSC == "F", "56", cDef01)              	  //Se for File, muda a defini็ใo para ser tanto Servidor quanto Local
		...
		nDecimal   := Iif(cGSC == "N", nDecimal, 0)               	  //Se nใo for parโmetro do tipo num้rico, serแ 0 o Decimal
		cTipo      := Upper(cTipo)                                	  //Deixa o tipo do Campo em mai๚sculo
		cTipo  	   := Iif(! cTipo $ 'C;D;N;', 'C', cTipo)     		  //Se o tipo do Campo nใo estiver entre Caracter / Data / Num้rico, serแ Caracter
		cGSC       := Upper(cGSC)                                 	  //Deixa o tipo do Parโmetro em mai๚sculo
		cGSC       := Iif(Empty(cGSC), 'G', cGSC)             		  //Se o tipo do Parโmetro estiver em branco, serแ um Get
		nTamanho   := Iif(cGSC == "C", 1, nTamanho)               	  //Se for Combo, o tamanho serแ 1
