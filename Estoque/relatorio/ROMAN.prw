...
If !lVersao
	...
	TRCell():New(oSection1,"B2_LOCALIZ" ,"SB2"," "+STR0042,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| If( mv_par27 ==1 .And. !Empty(SB2->B2_LOCALIZ) , SD3->D3_LOCAL+" - "+SB2->B2_LOCALIZ, "" )})
Else 
	NNR->(dbSetOrder(1))
	NNR->(dbSeek(xFilial("NNR")+SD3->D3_LOCAL))
	TRCell():New(oSection1,"NNR_DESCRI","NNR",STR0042,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| If( mv_par27 ==1 .And. !Empty(NNR->NNR_DESCRI) , SD3->D3_LOCAL+" - "+NNR->NNR_DESCRI, "" )})
EndIf
...
oSection1 :SetTotalText(STR0050) //"Total Produto"
...
If nOrdem <> 1
	TRFunction():New(oSection2:Cell("QTDENTRADA"),NIL,"SUM",/*oBreak2*/,,/*cPicture*/,/*uFormula*/,.T.,.F.,,oSection2)
	TRFunction():New(oSection2:Cell("QTDSAIDA")  ,NIL,"SUM",/*oBreak2*/,,/*cPicture*/,/*uFormula*/,.T.,.F.,,oSection2)
	TRFunction():New(oSection2:Cell("CUSTO")     ,NIL,"SUM",/*oBreak2*/,,/*cPicture*/,/*uFormula*/,.T.,.F.,,oSection2)
EndIf
