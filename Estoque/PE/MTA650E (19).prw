...
±±ºPrograma  ³ MTA650E   ºAutor  ³ Christian Rocha    º      ³           º±±
...
±±Ì          ³ Este ponto de entrada está sendo utilizado para subtrair a ¹±±
±±º          ³ a quantidade da ordem de produção do campo B2_QEMPN, pois  º±±
±±º          ³ o sistema não está realizando esta operação.				  º±±
