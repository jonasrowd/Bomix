...
±±ºPrograma  ³FACDA007  ºAutor  ³Francisco Rezende   º Data ³  01/16/15   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Programa responsavel por validar e gravar os unitizadores   º±±
±±º          ³no momento do cross docking                                 º±±
...
If dbSeek(xFilial("DCO") + c_Unitiz + c_CodAna)
	...
	VTAlert("Alocação do Unitizador " + AllTrim(c_CodAna) + " realizada com sucesso.", "Aviso")
Endif
