...
User Function BLTITAU1()
	...
	If (lOK .And. !IsBlind())
		...
		DEFINE MSDIALOG oDlg TITLE "Títulos" FROM 9,0 TO 400,800 PIXEL
...
Static Function FCriaSX1()
	Local oSX1 := CreateSX1():New("BLTITAU1") // Cria instância do objeto
