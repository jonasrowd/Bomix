...
User Function FGPER003()
	...
	Private l_Opcao	:= o_Telas:mtdParOkCan("Relação de funcionários demitidos","Esta rotina tem a finalidade de imprimir a relação de funcionários demitidos", " ", "Desenvolvido pela Totvs Bahia","FGPER003")
...
Static Function f_IntWord()
	...
	LjMsgRun("Aguarde... Gerando relatório","Relação de funcionários demitidos",{|| f_GeraRelatorio( c_FileOpen ) })
