...
Static Function printPage()
	...
	Else    
		...
		oPrinter:Say(0435,096,"DADOS ATUAL",o10N,,0)
		...
		oPrinter:Say(n_lin   ,0086,"CEP: " + c_Cep,o10N,,0)
		n_lin 		:=  n_lin + n_enter

		oPrinter:Say(n_lin   + 2  ,0086,"Bairro: " + c_Bairro,o10N,,0)
		n_lin 		:=  n_lin + (n_enter + 12)

		oPrinter:Say(n_lin  + 2,0086,"Cidade: "+ c_Municip ,o10N,,0)
		...
		oPrinter:Say(1695,0240,"Perante ao RH de minha empresa, dentro de um prazo de 30 (trinta) dias, caso venha ocorrer alguma alte-",o10N,,0)
		oPrinter:Say(1748,0238,"ração  OBS.: Declaro que as informacoes acima sao verdadeiras, bem como me comprometo desde ja a",o10N,,0)
		oPrinter:Say(1797,0233,"atualiza-las dos meus dados pessoais.",o10N,,0)

		oPrinter:Box(1986,1227,1986,2097)
		oPrinter:Say(2000,1456,"Assinatura do Funcionario",o10N,,0)
