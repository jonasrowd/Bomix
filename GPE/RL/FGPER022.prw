...
ฑฑบFun็ใo    ณ FGPER022	  บAutor ณ01-REGIS&CIA	     บ Data ณ  23/02/16   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Relat๓rio de Afastamentos								  บฑฑ
...
oPrinter:Say(0380,1055,"D.ADMISSรO",o8N,,0)
...
oPrinter:Say(0380,2025,"PERอODO ",o7N,,0)
...
While QRY->( !Eof() )
		...
		c_Dados += c_Matricula+";"+;
					...
					TRIM(IIF(f_PlanoSaude(QRY->MATRICULA),"Sim","Nใo"))+";"+;
					TRIM(IIF(a_Mes03[1][1],"Sim","Nใo"))+";"+;
					TRIM(IIF(a_Mes02[1][1],"Sim","Nใo"))+";"+;
					TRIM(IIF(a_Mes01[1][1],"Sim","Nใo"))+CHR(13)+CHR(10)
...
Static Function f_ExpCSV(c_Dados)
	...
	If !Empty(c_Dir)
		...
		c_Header  := "MATRอCULA;NOME;D.ADMISSรO;FUNวรO;DEPARTAMENTO;DATA;Dt.INI;Dt.FIM;DIAS NO PERอODO;DIAS DO ATESTADO;C.I.D;DESCRIวรO DO C.I.D;PLANO DE SAฺDE;"+a_Mes03[1][2]+";"+a_Mes02[1][2]+";"+a_Mes01[1][2]+";"
