...
User Function FGPER005()
	...
	Private l_Opcao	:= o_Telas:mtdParOkCan("Relacao de Funcionarios Admitidos","Esta rotina tem a finaldade de imprimir a relacao de funcionarios admitidos.", "Desenvolvido pela Totvs Bahia", "","FGPER005")
...
Static Function f_RelatPadrao()
	...
	Private oPrinter  	:=	tAvPrinter():New("Relação de Admitidos")
	oPrinter:Setup()
...
static function f_header (c_Emp,c_CNPJ)
	...
	oPrinter:Box(0177,0098,0288,2321)
	//cabeçalho
	oPrinter:Say(0175,0742,"Relação de Admitidos",oArial30,,0)
	...
	oPrinter:Say(0380,1140,"ADMISSÃO",o10N,,0)
	oPrinter:Say(0375,1471,"CARGO",o10N,,0)
	oPrinter:Say(0373,2048,"CRACHÁ",o10N,,0)
