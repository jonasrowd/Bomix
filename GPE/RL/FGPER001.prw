...
Static Function printPage()
	...
	WHILE	QRY->(!EOF())
		...
		oPrinter:Say(0800,0360,"Em cumprimento ao disposto no parágrafo 1. do Artigo 143 do Decreto_Lei número 1535 de 13 de Abril de ",oArial8N,,0)
   	    oPrinter:Say(0850,0360,"1977, venho pelo presente requerer o ABONO PECUNIÁRIO de 1/3 (um terço) das férias referente período ",oArial8N,,0)
