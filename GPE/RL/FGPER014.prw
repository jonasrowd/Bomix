...
Private l_Opcao	:= o_Telas:mtdParOkCan("COMUNICADO","Esta rotina tem a finaldade de", "imprimir comunicado de ponto eletronico", "Desenvolvido pela Totvs Bahia","FGPER014")
 ...
 //DADOS DA EMPRESA
  ...
  IF SRA->( DbSeek(xFilial("SRA")+mv_par01 ))
		...
		//If Alltrim(SRA->RA_SITFOLH) == " "
		  ...
		  oPrinter:Say(0788,0098, Alltrim(SRG->RG_TIPORES),oArial10N,,1)
		  ...
		  oPrinter:Say(0968,0949, Alltrim(SRG->RG_TIPORES),oArial10N,,1)
...
//	   ENDIF
  ...
  oPrinter:Say(1611,0074,"Foi prestada, gratuitamente, assistência na rescisão do contrato de trabalho, nos termos do artigo nº 477, ",o11N,,1)
  oPrinter:Say(1660,0072,"§ 1º , da consolidação das leis do trabalho (CLT), sendo comprovado neste ato efetivo pagamento das ",o11N,,1)
  oPrinter:Say(1704,0074,"verbas rescisórias especificadas no corpo do TRCT, no valor liquido de R$ 2 588, 36, o qual, devidamente ",o11N,,1)
  oPrinter:Say(1744,0072,"rubricado pelas partes, é parte integrante do presente Termo de Homologação.",o11N,,1)
  oPrinter:Say(1788,0070,"As partes assistidas no presente ato da rescisão contratual foram identificadas como legitimas conforme ",o11N,,1)
  ...
  oPrinter:Say(1828,0072,"previsto na Instrução Normativa/SRT nº 15/2010.",o11N,,1)
  ...
  oPrinter:Say(2414,1437,"Nome do Órgão Homologador",o11N,,1)
  ...
  oPrinter:Say(2875,0074,"Informaçoes à CAIXA",o11N,,1)

  oPrinter:Say(2935,0707,"A ASSISTENCIA NO ATO DE RESCISÃO CONTRATUAL É GRATUITA",o11N,,1)

  oPrinter:Say(2971,0400,"Pode o trabalhador iniciar ação judicial quanto aos creditos resultantes das relações de trabalho até o",o11N,,1)

  oPrinter:Say(3008,0400,"limite de dois anos após a extinção do contrato de de trabalho  (Inc. XXIX, Art. 7º da Constituição ",o11N,,1)
