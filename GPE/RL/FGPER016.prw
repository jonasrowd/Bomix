...
Static Function printPage()
  ...
  c_Data   := STRZERO(Day(SRA->RA_ADMISSA), 2) + " de " + MesExtenso(SRA->RA_ADMISSA) + " de " + STRZERO(Year(SRA->RA_ADMISSA), 4)  
		...
		oPrinter:Say(0353,0200,"Recebi da " + ALLTRIM(SM0->M0_NOMECOM) + " , o manual de Integração IT-PES-3 e o Kit ISO 9001, " ,oArial10N,,0)
		oPrinter:Say(0410,0200,"declarando, portanto ter sido informado de todo seu conteúdo.",oArial10N,,0)
