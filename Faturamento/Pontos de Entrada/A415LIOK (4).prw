...
±±ºPrograma  ³A415LIOK     º Autor ³ AP6 IDE            º Data ³  28/09/12º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Validação do Item do Orçamento                             º±±
±±º          ³ Este ponto de entrada é executado na mudança de linha do   º±±
±±º          ³ orçamento de venda. Ele pode ser utilizado para validação. º±±
...
////////
   ...
   // ALTERAÇÃO FEITA PARA ATENDER O WMS 06/03/2019 -WELLINGTON
