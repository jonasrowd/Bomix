...
oReport := TReport():New("FMATR550",STR0030,"MTR550P9R1", {|oReport| ReportPrint(oReport,cAliasQry,oSintetico,oItens,oItensD1,oItensD2,oCabec,oCabecF1,oCabecF2,oTotDia)},STR0031)  // "Relacao de Notas Fiscais"###"Este programa ira emitir a relacao de notas fiscais."
...
If cPaisLoc == "BRA"
	...
	TRCell():New(oItens,"CPEDIDO"		,/*Tabela*/,STR0043,PesqPict("SD2","D2_PEDIDO"),TamSX3("D2_PEDIDO" )[1]+2	,/*lPixel*/,{|| cPedido			})
	...
	TRCell():New(oTotDia,"CPEDIDO"		,/*Tabela*/,STR0043,/*Picture*/						,TamSX3("D2_PEDIDO"  )[1]+2					,/*lPixel*/,/*{|| code-block de impressao }*/	)
...
Else
	...
	TRCell():New(oItensD1,"PEDIDO"		,/*Tabela*/,RetTitle("D2_PEDIDO"	)	,/*Picture*/					,TamSX3("D2_PEDIDO"	)[1]+2	,/*lPixel*/,{|| cPedido		})
	...
	TRCell():New(oItensD2,"PEDIDO"		,/*Tabela*/,RetTitle("D2_PEDIDO"	)	,/*Picture*/					,TamSX3("D2_PEDIDO"	)[1]+2	,/*lPixel*/,{|| cPedido		})
	...
	TRCell():New(oTotGer,"PEDIDO"		,/*Tabela*/,RetTitle("D2_PEDIDO"	)	,/*Picture*/					,TamSX3("D2_PEDIDO"	)[1]+2	,/*lPixel*/,/*{|| code-block de impressao }*/	)
	...
	TRCell():New(oTotDia,"PEDIDO"		,/*Tabela*/,RetTitle("D2_PEDIDO"	)	,/*Picture*/					,TamSX3("D2_PEDIDO"	)[1]+2	,/*lPixel*/,/*{|| code-block de impressao }*/	)
    ...
    If TcSrvType()<>"AS/400"
		...
		If !Empty(_TBcFiltro)
			...
			WHERE F2_FILIAL = %xFilial:SF2%
	            ...
	            AND F2_VEND1 IN %Exp:_TBcFiltro%
				AND SF2.%notdel%
...
#IFNDEF TOP
	oReport:Section(2):Section(1):Cell("NACN6"		):SetBlock({||IIF((cAliasSD2)->D2_TIPO $ "P",xMoeda((cAliasSD2)->D2_VALIPI,1,MV_PAR13,(cAliasSD2)->D2_EMISSAO),xMoeda((cAliasSD2)->D2_TOTAL+(cAliasSD2)->D2_VALIPI+nTotRet,1,MV_PAR13,(cAliasSD2)->D2_EMISSAO, TAMSX3("D2_TOTAL")[2]))})	
#ELSE
...
If cPaisLoc == "MEX" .AND. SD2->(FieldPos("D2_VALADI")) > 0
	cExpTot := "% D2_TOTAL-D2_VALADI TOTAL, D2_VALADI %"
Else 
	cExpTot := "% D2_TOTAL TOTAL %"
EndIf
...
SELECT 	F2_CLIENTE CLIFOR,F2_LOJA LOJA,F2_DOC DOC,F2_SERIE SERIE,F2_EMISSAO EMISSAO
		...
		,D2_PRCVEN PRCVEN,%Exp:cExpTot% VALADI,D2_DESCON VALDESC,D2_ITEM ITEM, "2" TIPODOC %Exp:cCamposD2%
