...
ฑฑบPrograma  ณFFATR008  บAutor  ณ CHRISTIAN ROCHA      บ Data ณ ABR/2020  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Impressใo da Ordem de Saํda Bomix						  บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ SIGAFAT - Faturamento RELATORIO SUBSTITUI O FFATR001       บฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
*/
...
Static Function ImpCabec()     
	...
	oPrn:Say(950,100 , "- CARROCERIA"					,oFont04i,100)
	oPrn:Say(1000,100 , "- ASSOALHO"					,oFont04i,100)
	oPrn:Say(1050,100 , "- VERIFICACAO DE PRESENวA DE ALERGสNICOS"					,oFont04i,100) 
	oPrn:Say(1100,100 , "- VERIFICAวรO DE MATERIAL INAPROPRIADO NO BAฺ DO VEICULO."	,oFont04i,100)
	oPrn:Say(1150,100 , "- VERIFICAวรO DE PRESENวA DE ODORES."  					,oFont04i,100)
	oPrn:Say(1200,100 , "- VERIFICAวAO DE PRESENวA DE PRAGAS."  					,oFont04i,100)
	...
	oPrn:Say(950,1100, "[   ] LIBERADO COM RESTRIวีES      [   ] SEM CONDIวีES DE USO"		,oFont04,100)

	oPrn:Say(1000,600 , "[   ] INTACTO"														,oFont04,100)
	oPrn:Say(1000,1100, "[   ] LIBERADO COM RESTRIวีES      [   ] SEM CONDIวีES DE USO"		,oFont04,100)


	oPrn:Say(1050,1220, "[   ] SIM-BLOQUEAR CARREGAMENTO    [   ] NรO"						,oFont04,100)
	oPrn:Say(1100,1220, "[   ] SIM-BLOQUEAR CARREGAMENTO    [   ] NรO"						,oFont04,100)
	...
	*/
	...
	oPrn:Say(775,1550, "Vol/Und" 				,oFont03n,100)
	oPrn:Say(775,2050, "Quantidade"			,oFont03n,100)
...
Static Function ImpRodap()
	...
	*/
	...
	//	oPrn:Line( n_Lin,100,n_Lin + 280,100 )		//Linha vertical 1

	//	oPrn:Line( n_Lin,1220,n_Lin + 400,1220 )	//Linha vertical 2

	//	oPrn:Line( n_Lin,2350,n_Lin + 280,2350 )	//Linha vertical 3
