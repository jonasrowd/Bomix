...
/* ===============================================================================
WSDL Location    http://192.168.254.65:8081/webdesk/ECMWorkflowEngineService?wsdl
Gerado em        10/28/19 15:07:17
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _BECUZCM ; Return  // "dummy" function - Internal Use 
...
oXmlRet := SvcSoapCall(Self,cSoap,; 
	...
	"http://192.168.254.65:8081/webdesk/ECMWorkflowEngineService")
...
cSoap += WSSoapValue("processId", ::cprocessId, cprocessId , "string", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("choosedState", ::nchoosedState, nchoosedState , "int", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("colleagueIds", ::oWSstartProcesscolleagueIds, self:oWSstartProcesscolleagueIds , "stringArray", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("comments", ::ccomments, ccomments , "string", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("userId", ::cuserId, cuserId , "string", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("completeTask", ::lcompleteTask, lcompleteTask , "boolean", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("attachments", ::oWSstartProcessattachments, self:oWSstartProcessattachments , "processAttachmentDtoArray", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("cardData", ::oWSstartProcesscardData, self:oWSstartProcesscardData , "stringArrayArray", .T. , .T. , 0 , NIL, .F.,.F.) 
