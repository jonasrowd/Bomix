...
//Private l_Opcao	:= o_Telas:mtdOkCancel("Janela de Teste da Classe TestaTelas","Esta rotina tem a finaldade de", "Imprimir o abono pecuniario", "Desenvolvido pela Totvs Bahia")
	Private l_Opcao	:= o_Telas:mtdParOkCan("Contrato de Experiência","Esta rotina tem a finalidade de imprimir o contrato de trabalho a título de experiência", "", "Desenvolvido pela Totvs Bahia","FGPER002")
...
Static Function f_IntWord()
	...
	LjMsgRun("Aguarde... Gerando Relatório","Contrato a Título de Experiência",{|| f_GeraRelatorio( c_FileOpen ) })
...
Static Function f_ValidPerg(c_Perg)
	...
	Aadd(a_PAR02, "Horário de trabalho:")
