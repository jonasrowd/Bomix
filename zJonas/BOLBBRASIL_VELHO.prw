...
Do While SE1->(!EOF())
  If Marked("E1_OK")  // Imprime apenas os que foram marcado para impressใo 
		...
		Else
			...
			DbSelectArea("SEE")
			DbSetOrder(1)
			DbSeek(xFilial("SEE")+MV_PAR01+MV_PAR02+MV_PAR03+MV_PAR04)
		Endif
...
*/
	...
	aDadosTit	:= {NumTit											,;  // [1] N๚mero do tํtulo
						...
						IIF(Empty(SE1->E1_NUMBCO),aCB_RN_NN[3],SE1->E1_NUMBCO)               	,;  // [6] Nosso n๚mero (Ver f๓rmula para calculo)
...
If Empty(SE1->E1_NUMBCO) .or. MV_PAR11 = 1	
  ...
  MsUnlock()                                          
   ...
   //cDigNosso  := Alltrim(SE1->E1_NUMDV)
endif  
