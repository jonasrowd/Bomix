...
±±ºPrograma  ³FFINA002     º Autor ³ TBA001 -XXX     º Data ³  09/12/15º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Alterar os vencimentos dos Títulos baseando em acrescimo deº±±
±±º          ³ dias e condição de pagamento                               º±±
...
// alterado wellington  13/09/2018 desabilitado
	...
	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
  	...
  	Local cDesc1         := "Este programa tem como objetivo imprimir relatorio e ALTERAR os vencimentos dos Títulos Previstos "
  	Local cDesc2         := "de acordo com os parametros informados pelo usuario."
  	Local cDesc3         := "Títulos a Pagar"
  	Local cPict          := ""
  	Local titulo         := "Alterar Vencimento - Títulos a Pagar - Previstos"
	Local nLin           := 80
//	Local Cabec1         := "Fornecedor              Observação                                      Num.        Pc       Emissão    Vencimento            Valor         "
	Local Cabec1         := "Fornecedor                                                       Emissão Ant        Pc       Emissão    Vencimento            Valor         "
	Local Cabec2         := ""
	Local imprime        := .T.
	Local aOrd 			 := {}
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºFun‡„o    ³RUNREPORT º Autor ³ TBA001 -XXX     º Data ³  09/12/15   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
...
MemoWrit("C:\TEMP\FFINHIST.SQL",c_Historico)
