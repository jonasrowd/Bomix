...
//  	c_Qry += " (SELECT A2_NOME FORNECE, C7_OBS OBS, '' NOTA, C7_NUM PEDIDO, C7_EMISSAO EMISSAO, '' VENC, SUM(C7_TOTAL)+SUM(C7_VALIPI) AS VALOR, C7_COND CONDICAO, 'Previstos' TIPO" + chr(13)
  	...
  	c_Qry += " JOIN " + RetSqlName("SA2") + " SA2 ON A2_COD = C7_FORNECE AND (A2_COD BETWEEN '" + MV_PAR03 + "' AND '" + MV_PAR04 + "') AND SA2.D_E_L_E_T_<>'*' " + chr(13)
 	...
 	c_Qry += " SELECT E2_NOMFOR, E2_HIST, E2_NUM, '', E2_EMISSAO, E2_VENCREA, E2_VALOR, '', 'Pagar' " + chr(13)
...
//  	c_Qry += " WHERE E2_TIPO <> 'PA' AND E2_MULTNAT <> '1' AND E2_SALDO <> 0 AND SE2.D_E_L_E_T_<>'*' " + chr(13)
  	...
  	c_Qry += "   	UNION ALL " + chr(13)
 	c_Qry += " SELECT E1_NOMCLI, E1_HIST, E1_NUM, '', E1_EMISSAO, E1_VENCREA, E1_VALOR, '', 'Receber' " + chr(13)
...
//  	c_Qry += " WHERE E1_TIPO <> 'PA' AND E1_SALDO <> 0 AND SE1.D_E_L_E_T_<>'*' " + chr(13)
  	...
  	c_Qry += " AND (E1_VENCREA BETWEEN '" + Dtos(MV_PAR07) + "' AND '" + Dtos(MV_PAR08) + "')) TAB " + chr(13)
