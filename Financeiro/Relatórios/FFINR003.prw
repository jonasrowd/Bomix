...
ฑฑบPrograma  ณFFINR003  บAutor  ณ                    บ Data ณ			  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณRelatorio de Posi็ใo do Cliente/Fornecedor			      บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
Static Function ReportDef(nRegImp)
	Local cTitulo  := OemToAnsi("Posi็ใo do Cliente/Fornecedor")
	Local cDesc1   := "Posi็ใo do Cliente/Fornecedor"
	Local cDesc2   := ""
	Local oSection1
	...
	oSection1 := TRSection():New(oReport,"Posi็ใo do Cliente/Fornecedor",a_Tables,aOrdem)
...
Static Function f_ValidPerg(c_Perg)
	...
	Aadd(a_MV_PAR07, "Informe a Data de Emissใo inicial")
	Aadd(a_MV_PAR08, "Informe a Data de Emissใo final")
	Aadd(a_MV_PAR09, "Informe a Data da Posi็ใo")
	Aadd(a_MV_PAR10, "Informe a Posi็ใo a ser considerada")
	...
	PutSx1(c_Perg,"09","Data da Posi็ใo?      ","","","mv_ch9","D",08,0,0,"G","","" ,"","","mv_par09","","","","","","","","","","","","","","","","",a_MV_PAR09)
	PutSx1(c_Perg,"10","Posi็ใo?              ","","","mv_cha","N",01,0,0,"C","","","","","mv_par10","Cliente","","","","Fornecedor","","","","","","","","","","","",a_MV_PAR10)
