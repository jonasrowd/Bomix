...
oReport := TReport():New("FMATR600",STR0015,"MTR600", {|oReport| ReportPrint(oReport,oPedVC,oVendedor,oTotGer)},STR0016 + " " + STR0017)	// "Pedidos Por Vendedor/Cliente"###"Este relatorio ira emitir a relacao de Pedidos por"###"ordem de Vendedor/Cliente."
oReport:SetPortrait() 
...
TRCell():New(oPedVC,"NTOTPED1"	,		,STR0019					,PesqPict("SC6","C6_VALOR"),TamSx3("C6_VALOR"	)[1],/*lPixel*/,{|| nTotPed1 },,,"RIGHT")	// "Total"
...
TRCell():New(oTotGer,"NTOTGER"	,," "					,PesqPict("SC6","C6_VALOR"),TamSx3("C6_VALOR"	)[1],/*lPixel*/,{|| nTotGer },,,"RIGHT")	// "Total"
...
If mv_par15 ==  1
	TRFunction():New(oPedVC:Cell("NTOTPED1"),/* cID */,"SUM",/*oBreak*/,/*cTitle*/,/*cPicture*/,/*uFormula*/,.T./*lEndSection*/,.F./*lEndReport*/,/*lEndPage*/)
...
EndIf	
TRFunction():New(oPedVC:Cell("NTOTPED1"),/* cID */,"SUM",/*oBreak*/,/*cTitle*/,/*cPicture*/,/*uFormula*/,.T./*lEndSection*/,.F./*lEndReport*/,/*lEndPage*/,oVendedor)
...
If TcSrvType() != "AS/400"
	...
	If !Empty(_TBcFiltro)
		...
		WHERE SC5.C5_FILIAL = %xFilial:SC5%
			...
			AND SC5.C5_VEND1 IN %Exp:_TBcFiltro%
			AND %Exp:cWhere%
