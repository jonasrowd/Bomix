...
ฑฑบPrograma  ณFFATR002  บAutor  ณ CHRISTIAN ROCHA      บ Data ณ DEZ/2012  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Impressใo do Certificado de Qualidade Bomix 				  บฑฑ
...
Static Function ImpRel()     
	...
	//			oPrn:Say(n_lin ,1650, "OP"			,oFont03n,100)
				...
				oPrn:Say(n_lin , 1170, "Especifica็ใo"  	,oFont02n,100)
				oPrn:Say(n_lin , 1490, "Varia็ใo (+/-)"  	,oFont02n,100)
				oPrn:Say(n_lin , 1810, "M้dia"  	,oFont02n,100)
				oPrn:Say(n_lin , 2000, "Mํnimo"  	,oFont02n,100)
				oPrn:Say(n_lin , 2180, "Mแximo"  	,oFont02n,100)
				...
				If "BALDE" $ c_Produto .Or. "POTE" $ c_Produto
					...
					If QRY->BM_FSDFUNB > 0
						n_Lin += 25
						PulaPag(n_Lin)
						oPrn:Say(n_lin , 120, "Diโmetro do Fundo do Balde"  	,oFont02,100)
					...
					If QRY->BM_FSDEBB > 0
						n_Lin += 25
						PulaPag(n_Lin)			
						oPrn:Say(n_lin , 120, "Diโmetro Externo da Boca do Balde (A)"  	,oFont02,100)
					...
					If QRY->BM_FSDEMB > 0
						n_Lin += 25
						PulaPag(n_Lin)			
						oPrn:Say(n_lin , 120, "Diโmetro Externo Mแximo"  	,oFont02,100)
					...
					If QRY->BM_FSDIBB > 0
						n_Lin += 25
						PulaPag(n_Lin)			
						oPrn:Say(n_lin , 120, "Diโmetro Interno da Boca do Balde (B)"  	,oFont02,100)
					...
					If QRY->BM_FSPESOB > 0
						n_Lin += 25
						PulaPag(n_Lin)			
						oPrn:Say(n_lin , 120, "Peso do Balde sem Al็a"  	,oFont02,100)
					...
					If QRY->BM_FSPALCA > 0
						n_Lin += 25
						PulaPag(n_Lin)			
						oPrn:Say(n_lin , 120, "Peso da Al็a"  	,oFont02,100)
				...
				Else
					If QRY->BM_FSDTAMP > 0
						n_Lin += 25
						PulaPag(n_Lin)
						oPrn:Say(n_lin , 120, "Diโmetro da Tampa"  	,oFont02,100)
				...
				n_Lin += 25
				PulaPag(n_Lin)			
				oPrn:Say(n_lin , 120, "Colora็ใo/Inspe็ใo em Linha"  	,oFont02,100)
				...
				n_Lin += 25
				PulaPag(n_Lin)			
				oPrn:Say(n_lin , 120, "Manchas/Inspe็ใo em Linha"  	,oFont02,100)
				oPrn:Say(n_lin , 1240, "OK"  	,oFont02,100)
				oPrn:Say(n_lin , 2000, ""  	,oFont02,100)
				...
				n_Lin += 25
				PulaPag(n_Lin)			
				oPrn:Say(n_lin , 120, "Poeira/Inspe็ใo em Linha"  	,oFont02,100)
				oPrn:Say(n_lin , 1240, "OK"  	,oFont02,100)
				oPrn:Say(n_lin , 2000, ""  	,oFont02,100)
				...
				n_Lin += 25
				PulaPag(n_Lin)			
				oPrn:Say(n_lin , 120, "Rebarbas/Inspe็ใo em Linha"  	,oFont02,100)
				oPrn:Say(n_lin , 1240, "OK"  	,oFont02,100)
				oPrn:Say(n_lin , 2000, ""  	,oFont02,100)
				...
				n_Lin += 25
				PulaPag(n_Lin)			
				oPrn:Say(n_lin , 120, "Resist๊ncias/Ensaio Conf.Norma NBR14952 da ABNT"  	,oFont02,100)
				oPrn:Say(n_lin , 1240, "OK"  	,oFont02,100)
				oPrn:Say(n_lin , 2000, ""  	,oFont02,100)
				...
				// Brito - Inclusใo Data de Validade
				n_Lin += 25
				PulaPag(n_Lin)			
...
//oPrn:Say(275,1720, "Responsแvel: "	,oFont02,100)

oPrn:Line( 325,100,325,2350 )

oPrn:Say(350 ,100, "Nota Fiscal:"	,oFont02n,100)  
//oPrn:Say(350,1720, "Nบ Pedido:"			,oFont03n,100)  
oPrn:Say(400 ,100, "Cliente:"  			,oFont02n,100)
oPrn:Say(450 ,100, "Endere็o:"			,oFont02n,100)
...
oPrn:Say(675 ,130 , "A Bomix Ind๚stria de Embalagens Ltda certifica as propriedades dos Lotes de sua fabrica็ใo,"		,oFont02n,100)
oPrn:Say(725 ,130 , "de acordo com os valores abaixo. Estes valores refletem os resultados dos controles "	,oFont02n,100)
oPrn:Say(775 ,130 , "realizados sobre uma atmosfera representativa do(s) lote(s) em refer๊ncia."				,oFont02n,100)
...
Static Function ImpRodap()
	...
	n_lin += 40
	oPrn:Say(n_Lin ,200, "Filial Sใo Paulo: Rua Helena Conci Gaspari, 110 - Jd Campos Elsios - CEP: 13.209-810 - Jundiaํ - SP - Tel: (11) 4523-0100 - Fax: (11) 4522-4399 - E-mail: bomixsp@bomix.com.br"					,oFont04,100)
...
PutSx1(c_Perg,"04","Cliente at้ ?"  		,"","","mv_ch4","C",06,0,0,"G","","SA1","","","mv_par04","","","","","","","","","","","","","","","","")
...
c_Qry += " JOIN " + RetSqlName("SA1") + " SA1 ON A1_FILIAL = '" + XFILIAL("SA1") + "' AND A1_COD = C5_CLIENTE AND SA1.D_E_L_E_T_<>'*' " + chr(13)
...
c_Qry += " WHERE C5_NUM BETWEEN '" + MV_PAR01 + "' AND '" + MV_PAR02 + "' AND SC5.D_E_L_E_T_<>'*' " + chr(13)
