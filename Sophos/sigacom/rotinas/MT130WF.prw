...
/*
ฑฑบฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑบฑฑ
ฑฑบDesc:        ณPonto de entrada para envio de Workflow na cota็ใo de com- บฑฑ
ฑฑบ             ณpras                                                       บฑฑ
ฑฑบProgramador: ณSandro Santos                          Data: 08\01\2013    บฑฑ
ฑฑบUso:         ณ AP                                                        บฑฑ
ฑฑบAltera็ใo:	ณ 															บฑฑ
ฑฑบฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑบฑฑ
*/
...
while !eof() .and. xFilial("SC8")+ParamIXB[1]==C8_FILIAL+C8_NUM
	...
	If Empty(_cEmlFor)
		If MsgYesNo("O Fornecedor "+SA2->A2_COD+"-"+SA2->A2_NOME+" nใo tem um email cadsatrado, deseja cadastrar agora?")
	...
	if Alltrim(_cEmlFor) <> ""
		...
		oProcess := TWFProcess():New( "000001", "Cota็ใo de Pre็os" )
...
//		oHtml:ValByName( "Valipi"   , TRANSFORM( 0 ,'@E 999,999.99' ) )
		...
		oProcess:cSubject := "Processo de gera็ใo de Cota็ใo de Pre็os " + _cC8_NUM
...
if oProcess:oHtml:RetByName("Aprovacao") = "S"
	...
	RastreiaWF(oProcess:fProcessID+'.'+oProcess:fTaskID,"000001",'1004',"Email respondido pelo Fornecedor:"+_cC8_FORNECE,RetCodUsr())
	...
	for _nind := 1 to len(oProcess:oHtml:RetByName("it.preco"))
		...
		//caso o prazo tenha vencido nใo permite gravacao
		If C8_WFID = "9999"
			Return
		EndIf
		RecLock("SC8",.f.)
...
ฑฑบPrograma  ณReprovar  บAutor  ณMicrosiga           บ Data ณ  11/23/05   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
oProcess:cCC      := ""
oProcess:cBCC     := ""
oProcess:cSubject := "Desist๊ncia do Fornecedor"
