...
@Li,00 PSay "VERIFICAÇÕES"				//VERIFICAÇÕES
Li++

@Li,00 PSay "Nível do Lubrificante: ( )Alto   ( )Normal   ( )Baixo                  Máquina: ( )Limpa   ( )Suja                  Matéria Prima: ( )Ok"
Li++
...
Li++
@Li,00 PSay "                               Auxiliar da Produção                    Encarregado Produção                    Responsável Produção"
Li++
...
Li++
@Li,00 PSay "ANÁLISE VISUAL:"
Li++
@Li,00 PSay "Coloração/Inspeção em Linha: ( )Homogênea   ( )Não Homogênea                  Manchas/Inspeção em Linha : ( )Ausência   ( )Presença"
Li++
@Li,00 PSay "Poeira/Inspeção em Linha   : ( )Ausência    ( )Presença                       Rebarbas/Inspeção em Linha: ( )Muitas     ( )Nenhuma    ( )Poucas"
Li+=2
...
Else
	@Li,00 PSay "Altura            :" + Str(SBM->BM_FSALTB) + "     Diâmetro Fundo:" + Str(SBM->BM_FSDFUNB) + "     Diâmetro Ext. Boca:" + Str(SBM->BM_FSDEBB) + "     Diâmetro Ext. Max:" + Str(SBM->BM_FSDEMB) + "    Peso:" + Str(SBM->BM_FSPESOB)
	Li++
	@Li,00 PSay "Diâmetro Int. Boca:" + Str(SBM->BM_FSDIBB) + "     Volume Nominal:" + Str(SBM->BM_FSVNB)   + "     Volume Real       :" + Str(SBM->BM_FSVRB)  + "     Volume Total     :" + Str(SBM->BM_FSVTB)
Endif
Li++
@Li,00 PSay __PrtFatLine()
Li++
